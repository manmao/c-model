/***************************************
    对底层时间轮的实际操作
******************************************/
#ifndef __TIME_WHEEL_TIMER_
#define __TIME_WHEEL_TIMER_
...
public:
	...
	tw_timer* add_timer(int timeout,TimerHandler *handler)
	{
...
void del_timer(tw_timer* timer)
{
	...
	void tick()
	{
		...
		//	printf("tick the timer once\n");
			...
			{
			    //执行任务函数
			    tmp->handler->handle(tmp->handler->getData());
